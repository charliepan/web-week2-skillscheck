...
// Code Here
const doubled = myNumbers.map((val,i,arr) => {
	return arr[i] * 2;
});
//////////////////PROBLEM 15////////////////////
...
// Code Here
const total = myNumbers.reduce((tot,val) =>{
	return tot + val;
});
//////////////////PROBLEM 17////////////////////
...
// Code Here
const forTheLoveOfGeorge = notGeorge.map((val,i,arr) => {
	return arr[i] = 'George';
});
//////////////////PROBLEM 19////////////////////
...
// Code Here
const totallyAwesome = people.reduce((tot,val) =>{
	return tot + val.awesomeLevel;
},0);